...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        self.params = {
            ...
            'W2': np.random.normal(0, weight_scale, (num_filters * (H // 2) * (W // 2), hidden_dim)),
    ...
    def loss(self, X, y=None):
        ...
        out, L1_cache = conv_relu_pool_forward(X, W1, b1, conv_param, pool_param)
        out, L2_cache = affine_relu_forward(out, W2, b2)
